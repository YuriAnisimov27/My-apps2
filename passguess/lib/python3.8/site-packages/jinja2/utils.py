...
def contextfunction(f):
    ...
    to the context or functions provided on the context object.  For examples
...
def is_undefined(obj):
    ...
    undefined variables.  For examples a custom default filter can look like
    this::
...
def object_type_repr(obj):
    ...
    examples for `None` and `Ellipsis`).
    """
    if obj is None:
        return "None"
...
class Cycler(object):
    ...
    multiple loops. For examples, render a list of folders and files in a
