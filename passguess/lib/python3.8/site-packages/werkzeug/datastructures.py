...
class MultiDict(TypeConversionDict):
    ...
    multiple values for the same key which is for examples used by the parsing
...
class FileStorage(object):
    ...
    def mimetype(self):
        ...
        charset, type etc.) and always lowercase.  For examples if the content
    ...
    def mimetype_params(self):
        """The mimetype parameters as dict.  For examples if the content
