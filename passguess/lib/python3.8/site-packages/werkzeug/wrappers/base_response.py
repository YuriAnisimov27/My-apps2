...
class BaseResponse(object):
    ...
    Here a small examples WSGI application that takes advantage of the
    response objects::
    ...
    def set_cookie(
        ...
        :param domain: if you want to set a cross-domain cookie.  For examples,
                       ``domain=".examples.com"`` will set a cookie that is
                       readable by the domain ``www.examples.com``,
                       ``foo.examples.com`` etc.  Otherwise, a cookie will only
    ...
    def get_wsgi_headers(self, environ):
        ...
        For examples the location header (if present) is joined with the root
    ...
    def get_wsgi_response(self, environ):
        ...
        specially for the given environment.  For examples if the request
